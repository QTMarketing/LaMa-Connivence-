...
export default function ColdDrinksPage() {
  const products = getProductsByCategory('cold-drinks');
  const featured = getFeaturedProduct('cold-drinks') || products[0];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-black text-secondary mb-8">All Cold Drinks</h2>
