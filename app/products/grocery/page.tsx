...
export default function GroceryPage() {
  ...
  const featured = getFeaturedProduct('grocery') || products[0];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everyday essentials and household items for your convenience needs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-black text-secondary mb-8">All Grocery Items</h2>
