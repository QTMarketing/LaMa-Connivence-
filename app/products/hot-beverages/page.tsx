...
export default function HotBeveragesPage() {
  const products = getProductsByCategory('hot-beverages');
  const featured = getFeaturedProduct('hot-beverages') || products[0];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-black text-secondary mb-8">All Hot Beverages</h2>
