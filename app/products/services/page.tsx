...
export default function ServicesPage() {
  const products = getProductsByCategory('services');
  const featured = getFeaturedProduct('services') || products[0];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Convenient services to make your visit even better. From ATMs to fuel, we've got you covered.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-black text-secondary mb-8">All Services</h2>
